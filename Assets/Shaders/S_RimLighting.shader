Shader "LucasShaders/RimLighting"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half4 TexureSample = SAMPLE_TEXTURE2D(_BaseTex, sampler_BaseTex, IN.uv);
                half3 finalColor = TexureSample + _BaseColor.rgb + _RimColor.rgb * rimLighting;
